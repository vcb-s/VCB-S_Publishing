...
3. 如果是新番，应该有总监提供的吐槽和截图，并翻译为英文版，若非对自己翻译水平很自信，请使用推理模型（如 Gemini-2.5pro，Deepseek-R1，OpenAI o3 等）和 [prompt 模版](https://github.com/vcb-s/VCB-S_Publishing/blob/master/prompt%E6%A8%A1%E6%9D%BF.md) 完成翻译。
...
感谢所有参与制作者: 总监: XXX 压制: XXX 整理: XXX 发布: XXX 分流: VCB-Studio CDN 分流成员
...
[box style="download"] 10-bit 1080p HEVC (Reseed)<!-- 在 box 下第一行紧跟着标注画质，位深，编码，如果是 Reseed 记得标 Reseed -->
...
[box style="download"] 10-bit 1080p AVC
...
| -------------: | :------------------------------------ |
|     千夏字幕组 | Airota                                |
|     喵萌奶茶屋 | Nekomoe kissaten / 喵萌Production[^1] |
| 悠哈璃羽字幕社 | UHA-WINGS                             |
|     诸神字幕组 | Kamigami                              |
|     天香字幕社 | T.H.X                                 |
|   动漫国字幕组 | DMG                                   |
